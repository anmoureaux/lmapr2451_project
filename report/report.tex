...
\subsection{Determination of the lattice parameters (preliminary structural relaxation)}
...
\hline
\multirow{1}{*}{Convergence of \texttt{etotal/atom}} & 40 & [4 4 4]\\
\hline
\multirow{1}{*}{Convergence of \texttt{acell}} & e & f\\   
\hline           
\end{tabular}
\end{center}
\newpage
