...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{images/bs.pdf}
\caption{Band structure of \ch{FeS2}. The red dots represent the valence band minimums and the conduction band maximum.}
\label{fig:bs}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth,height=3.2in]{images/chart.pdf}
\caption{Band structure of \ch{FeS2} provided by the Materials Project.}
\label{fig:bsMP}
\end{figure}
