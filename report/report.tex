...
\label{fig:acellConv}
\end{figure}
However, the converged value for \texttt{acell} will be the one corresponding to \texttt{ngkpt} = \texttt{[5 5 5]}, as it is the most accurate iteration. It is equal to \begin{center}\texttt{6.46340804703829E+00  8.46153537249437E+00  1.03166669446974E+01 Bohr},\end{center} which corresponds to \begin{center}\texttt{3.175063264799999452 4.233417686399999269  5.291772107999999974 Angstrom}.\end{center}
Those values will be used in the further computations.
\subsection{Convergence with respect to the broadening factor (\texttt{tsmear})}
