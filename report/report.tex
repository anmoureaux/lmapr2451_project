...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{comment}
The electrical displacement $\mathbf{D}$ in the material is linked to the electric field $\mathbf{E}$ and the polarization $\mathbf{P}$ by the following relations : 
\begin{align}\mathbf{D}&=\varepsilon_0\mathbf{E}+\mathbf{P}\\
&=\varepsilon_0\mathbf{E}+\varepsilon_0\chi\mathbf{E}\\
&=\varepsilon_0(1+\underline{\underline{\chi}})\mathbf{E}\\
&=\varepsilon_0\underline{\underline{\varepsilon_r}}\mathbf{E}\\
&=\underline{\underline{\varepsilon}}\mathbf{E}
\end{align}
where $\varepsilon_0$ is the \textit{vacuum permittivity}, $\underline{\underline{\varepsilon_r}}$ is the \textit{relative permittivity} of the material and $\underline{\underline{\chi}}$ is the \textit{electric susceptibility} of the material.
The dielectric constant tensor is obtained by dividing the dielectric tensor by the vacuum permittivity $\varepsilon_0 = 8.85418782\times 10^{-12}$ [A$^2$s$^4$kg$^{-1}$m$^{-3}$]:
\begin{equation}
\underline{\underline{\varepsilon_r}} = \left(\begin{array}{ccc}
\end{array}\right)
\end{equation}
The electric susceptibility tensor of the material, which represents the polarization of the material induced by an electric field, is thus 
$$\underline{\underline{\chi}} = \left(\begin{array}{ccc}
\end{array}\right)$$
\end{comment}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{align}
\label{angfreq}
\nu &= \dfrac{0.8674\times 1.60218\times 10^{-19}}{6.62607\times 10^{-34}}\\
